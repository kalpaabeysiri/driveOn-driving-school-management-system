...
import { updateTheoryExam } from '../../../services/examApi';
import SimplePicker from '../../../components/admin/exam/SimplePicker';

const EditTheoryExamScreen = ({ navigation, route }) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.locationOrHall.trim()) newErrors.locationOrHall = 'Location is required';
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await updateTheoryExam(exam._id, formData);
      Alert.alert('Success', 'Theory exam updated successfully', [
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['bottom']}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Edit Theory Exam</Text>
...
export default EditTheoryExamScreen;
