...
import { getPracticalExams, deletePracticalExam } from '../../../services/examApi';
...
export default function PracticalExamListScreen({ navigation }) {
  ...
  const handleDelete = (exam) => {
    Alert.alert(
      'Delete Exam',
      `Are you sure you want to delete this "${exam.vehicleCategory} Practical Exam"?`,
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              await deletePracticalExam(exam._id);
        ...
        {user?.role === 'admin' && (
          <View style={styles.cardActions}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('EditPracticalExam', { exam })}
            >
